...
Documentos_aprobados = Blueprint("documentos_aprobados", __name__)

@Documentos_aprobados.route('/documentos_aprobados')
def documentos_aprobados():
    ...
    for i in perfile:
        p.extend(i)
    return render_template('./Verifica_informacion/documentos_aprobados.html', perfiles = p, tema = t, funcionario = f)



@Documentos_aprobados.route('/f_visualizar_subtemas_aprobados', methods=["POST"])
def f_visualizar_subtemas_aprobados():
    try:
        ...
        print("This is an error message f_visualizar_subtemas_aprobados !{}".format(e))
    

@Documentos_aprobados.route('/visualiza_documento_aprobados', methods=["POST"])
def visualiza_documento_aprobados():
    try:
        ...
        print("This is an error message visualiza_documento_aprobados !{}".format(e))
  


@Documentos_aprobados.route('/p_aprobar_documento_aprobado', methods=["POST"])
...
@Documentos_aprobados.route('/p_devolver_documento_aprobado', methods=["POST"])
...
# @Documentos_aprobados.route('/f_tabla_onsevaciones_documento', methods=["POST"])
